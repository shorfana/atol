        ...
        <div id="wrapper">
            ...
            <div class="left side-menu">
                <div class="user-details">
                    ...
                    <div class="user-info">
                        <a href="#"><?php echo $_SESSION['username_sadmin'] ?></a>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu" id="side-menu">
                        ...
                        <li>
                            <a href="<?php echo base_url() ?>Superadmin/registerAdmindinas">
                                <i class="ti-pencil-alt"></i> <span> Pengelolaan data Wilayah </span>
                            </a>
                        </li>

                        <li>
                            <a href="<?php echo base_url() ?>Superadmin/pengelolaan_data_admin_dinas">
                                <i class="ti-pencil-alt"></i> <span> Pengelolaan data <br>Admin Dinas</span>
                            </a>
                        </li>
